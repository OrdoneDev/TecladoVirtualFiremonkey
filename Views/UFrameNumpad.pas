...
type
  ...
  public
    { Public declarations }
    constructor Create(_AOwner: TComponent; _SenderFocus: TObject; _Integer: boolean); overload;
...
constructor TFrameNumpad.Create(_AOwner: TComponent; _SenderFocus: TObject; _Integer: boolean);
begin
